...
function install_config_file(string $adapter, string $dbPrefix, array $dbConfig, bool $return = false): string
{
    ...
    $fallbackConfig = var_export($dbConfig, true);
...
PHP;
    ...
    $code = str_replace('%ADAPTER%', addslashes($adapter), $code);
    $code = str_replace('%DBPREFIX%', addslashes($dbPrefix), $code);
    $code = str_replace('%FALLBACK_CONFIG%', $fallbackConfig, $code);
